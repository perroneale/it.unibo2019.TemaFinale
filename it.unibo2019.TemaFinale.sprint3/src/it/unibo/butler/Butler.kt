		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
					 ...
					 transition( edgeName="goto",targetState="waitCmd", cond=doswitchGuarded({noRobot == false}) )
					transition( edgeName="goto",targetState="test", cond=doswitchGuarded({! noRobot == false}) )
				}	 
				...
				state("waitCmd") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t033",targetState="handleRobotAction",cond=whenDispatch("robotAction"))
				}	 
