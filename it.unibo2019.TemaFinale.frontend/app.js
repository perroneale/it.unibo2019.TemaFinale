...
app.post('/stop', function(req,res,next){
  mqtt.publish("unibo/qak/butlerresourcemodel", "msg(modelChangeTask,dispatch,maitre,butlerresourcemodel,modelChangeTask(robot, stop, 0, 0),1)");
  res.redirect('localhost:3000/');
});
app.post('/reactivate', function(req,res,next){
  mqtt.publish("unibo/qak/butlerresourcemodel", "msg(modelChangeTask,dispatch,maitre,butlerresourcemodel,modelChangeTask(robot, reactivate, 0, 0),1)");
  res.redirect('localhost:3000/');
});
