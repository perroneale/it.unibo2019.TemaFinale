		...
		return { //this:ActionBasciFsm
				...
				state("waitCmd1") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t05",targetState="preparing",cond=whenEvent("modelChangedpreparing"))
				}	 
				...
				state("waitCmd2") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t09",targetState="adding",cond=whenEvent("modelChangedadding"))
					transition(edgeName="t010",targetState="cleaning",cond=whenEvent("modelChangedcleaning"))
				}	 
